...
>     -   **Observed variables** = Reported effect sizes (e.g., SMD, odds ratios).\
>     -   **Latent variables** = True population effects (modeled as unobserved constructs).\
> -   **Advantages**:
...
**Equation**: *y*<sub>*i*</sub> = *β*<sub>*F*</sub> + *e*<sub>*i*</sub>,  *e*<sub>*i*</sub> ∼ *N*(0, *v*<sub>*i*</sub>)

**SEM Representation**: - No latent variables.\
- Fixed parameter: *β*<sub>*F*</sub> (common effect).\
- Known sampling variance *v*<sub>*i*</sub> fixed via definition variables.
...
**Equation**: *y*<sub>*i*</sub> = *β*<sub>*R*</sub> + *u*<sub>*i*</sub> + *e*<sub>*i*</sub>,  *u*<sub>*i*</sub> ∼ *N*(0, *τ*<sup>2</sup>),  *e*<sub>*i*</sub> ∼ *N*(0, *v*<sub>*i*</sub>)

**SEM Representation**: - **Latent variable**: *f*<sub>*i*</sub> ∼ *N*(*β*<sub>*R*</sub>, *τ*<sup>2</sup>) (true effect).\
- **Observed variable**: *y*<sub>*i*</sub> = *f*<sub>*i*</sub> + *e*<sub>*i*</sub>, with *e*<sub>*i*</sub> ∼ *N*(0, *v*<sub>*i*</sub>).
...
**Equation**: *y*<sub>*i*</sub> = *β*<sub>0</sub> + *β*<sub>1</sub>*x*<sub>*i*</sub> + *u*<sub>*i*</sub> + *e*<sub>*i*</sub>,  *u*<sub>*i*</sub> ∼ *N*(0, *τ*<sup>2</sup>)

**SEM Representation**: - **Latent variable**: *f*<sub>*i*</sub> ∼ *N*(*β*<sub>0</sub> + *β*<sub>1</sub>*x*<sub>*i*</sub>, *τ*<sup>2</sup>).\
- **Observed variable**: *y*<sub>*i*</sub> = *f*<sub>*i*</sub> + *e*<sub>*i*</sub>, with *e*<sub>*i*</sub> ∼ *N*(0, *v*<sub>*i*</sub>).

**Interpretation**: - *β*<sub>1</sub>: Change in effect size per unit increase in *x*<sub>*i*</sub>.\
- $R^2 = \frac{\tau^2\_{\text{without } x} - \tau^2\_{\text{with } x}}{\tau^2\_{\text{without } x}}$: Variance explained by *x*<sub>*i*</sub>.
...
>
> 1.  **Latent Variables**:
>     -   Separate true effects (*f*<sub>*i*</sub>) from sampling error (*e*<sub>*i*</sub>).\
>     -   Example: If *τ*<sup>2</sup> = 0, all variability is due to sampling error (fixed-effect model).
> 2.  **Definition Variables**:
>     -   Fix known sampling variances (*v*<sub>*i*</sub>) as constants per study.
> 3.  **Missing Data**:
...
+================+==========================+==============================+=================+
| Fixed-Effect   | yi = βF + ei             | No latent variables          | `meta(y, v)`    |
+----------------+--------------------------+------------------------------+-----------------+
| Random-Effects | yi = βR + ui + ei        | Latent fi ∼ N(βR, τ2)        | `meta(y, v)`    |
+----------------+--------------------------+------------------------------+-----------------+
| Mixed-Effects  | yi = β0 + β1xi + ui + ei | Latent fi ∼ N(β0 + β1xi, τ2) | `meta(y, v, x)` |
+----------------+--------------------------+------------------------------+-----------------+
